(function groceryItemSaveModule() {
    angular
        ...
        .component('groceryItemSave', {
            ...
            controller: ['groceryItemsResource', '$routeParams', function GrocerySaveController(groceryItemsResource, $routeParams)
            {
                ...
                groceryItemsResource.get({ id: self.id }, function grcitemsave(data) {
